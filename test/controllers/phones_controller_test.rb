...
class PhonesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create phone" do
    assert_difference('Phone.count') do
      post phones_url, params: { phone: { company: @phone.company, dat: @phone.dat, image: @phone.image, pmodel: @phone.pmodel } }
    end
  ...
  test "should update phone" do
    patch phone_url(@phone), params: { phone: { company: @phone.company, dat: @phone.dat, image: @phone.image, pmodel: @phone.pmodel } }
